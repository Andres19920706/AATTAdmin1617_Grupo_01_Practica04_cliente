...
public class AutenticaClient extends javax.swing.JFrame {
    ...
    private void doAuth(String data) throws SignatureError, NoSuchAlgorithmException, InvalidKeyException {
        ...
        try {
            //Inicializamos la clave privada de la identidad cuya firma se va a generar.
            ...
            try {
                // Firmamos los datos solicitados por el cliente
                ...
                try {
                    ...
                    System.out.println("Resutlado de la firma en Base64: \n"+Arrays.toString(datosBase64));
